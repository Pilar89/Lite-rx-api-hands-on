...
//========================================================================================
   ...
   Flux <User> usuarios = repository.findAll()
     .doOnSubscribe(suscripcion -> System.out.println("Starring:"))
     .doOnNext(valores -> System.out.println(valores.getFirstname()+" "+valores.getLastname()))
